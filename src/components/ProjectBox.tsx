        ...
        <div className="basis-[78%] flex flex-col md:gap-0 gap-1">
          ...
          {trackingUrl && (
            <a
              ...
              className="inline-flex items-center gap-2 mb-2 px-3 py-1.5 text-sm font-medium bg-green-400/10 hover:bg-green-400/20 text-green-400 border border-green-400/30 rounded-md transition-all duration-200 w-fit"
            >
